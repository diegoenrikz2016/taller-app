...
import static com.taller.app.domain.ServicioAsserts.*;
...
class ServicioResourceIT {
    ...
    public static Servicio createEntity() {
        return new Servicio().nombre(DEFAULT_NOMBRE).precio(DEFAULT_PRECIO);
    }
    ...
    public static Servicio createUpdatedEntity() {
        return new Servicio().nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO);
    }
    ...
    void putExistingServicio() throws Exception {
        ...
        updatedServicio.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO);
    ...
    void fullUpdateServicioWithPatch() throws Exception {
        ...
        partialUpdatedServicio.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO);
