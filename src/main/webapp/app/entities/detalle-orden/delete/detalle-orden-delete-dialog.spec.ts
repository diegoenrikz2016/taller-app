...
import { DetalleOrdenDeleteDialog } from './detalle-orden-delete-dialog';

describe('DetalleOrden Management Delete Component', () => {
  let comp: DetalleOrdenDeleteDialog;
  let fixture: ComponentFixture<DetalleOrdenDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DetalleOrdenDeleteDialog);
