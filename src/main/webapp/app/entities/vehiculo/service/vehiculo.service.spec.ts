...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../vehiculo.test-samples';
...
describe('Vehiculo Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Vehiculo', () => {
      ...
      service.create(vehiculo).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Vehiculo', () => {
      ...
      service.update(vehiculo).subscribe(resp => (expectedResult = resp));
    ...
    describe('addVehiculoToCollectionIfMissing', () => {
      it('should add a Vehiculo to an empty array', () => {
        ...
        expect(expectedResult).toEqual([vehiculo]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([vehiculo, vehiculo2]);
      });
